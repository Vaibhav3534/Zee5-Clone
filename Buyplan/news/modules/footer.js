document.getElementById("footer_top").innerHTML = `
        ...
        <div class="container">
          <div class="socialmedia">
            <div class="social">
              ...
              <a
                ...
                ><img
                  src="https://www.zee5.com/images/play_store.png?ver=2.50.94"
              /></a>
              <a
                href="https://apps.apple.com/in/app/zee5-shows-live-tv-movies/id743691886"
                ><img
                  src="https://www.zee5.com/images/app_store.png?ver=2.50.94"
              /></a>
            </div>
            <div class="socialmedialogo">
              <h2 style="color: rgb(216, 215, 215); font-size: 15px">
                Connect with us
              </h2>

              <a href="https://www.facebook.com/ZEE5/" class="fb"
                ><i class="fa-brands fa-facebook-square"></i
              ></a>
              <a href="https://www.instagram.com/zee5/" class="insta"
                ><i class="fa-brands fa-instagram"></i
              ></a>
              <a href="https://twitter.com/zee5india" class="twitter"
          ...
          <div class="ending_para">
            Best viewed on Google Chrome 80+, Microsoft Edge 81+, Mozilla
            Firefox 75+, Safari 5.1.5+ Copyright © 2022 Zee Entertainment
